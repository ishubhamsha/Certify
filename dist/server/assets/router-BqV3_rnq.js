import { W as reactExports, I as isPromise, J as isRedirect, H as isNotFound, C as invariant, g as createControlledPromise, a2 as rootRouteId, K as isServer$1, v as functionalUpdate$1, b as arraysEqual, h as createLRUCache, e as compileDecodeCharMap, a4 as trimPath, a1 as rewriteBasepath, f as composeRewrites, V as processRouteTree, U as processRouteMasks, a0 as resolvePath, d as cleanPath, a6 as trimPathRight, S as parseHref, q as executeRewriteInput, E as isDangerousProtocol, X as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, B as interpolatePath, Q as nullReplaceEqualDeep, Z as replaceEqualDeep$1, N as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, A as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a5 as trimPathLeft, L as joinPaths, a8 as useRouter, m as dummyMatchContext, P as matchContext, x as getDefaultExportFromCjs, _ as requireReactDom, p as exactPathTest, Y as removeTrailingSlash, R as React, M as jsxRuntimeExports, G as isModuleNotFoundError, a7 as useHydrated, o as escapeHtml, F as isInlinableStylesheet, w as getAssetCrossOrigin, $ as resolveManifestAssetLink, O as Outlet } from "./server-CUL67baf.js";
...
const appCss = "/assets/styles-BYyHxt9l.css";
...
const Route$4 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Certify — AI-Powered YouTube Certification" },
      { name: "description", content: "Turn any YouTube video into a certified learning experience: transcript, AI summary, adaptive quiz, certificate." },
      { property: "og:title", content: "Certify — AI-Powered YouTube Certification" },
      { property: "og:description", content: "Paste a YouTube URL. Get a transcript, AI summary, quiz, and a printable certificate." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700;800&family=IBM+Plex+Sans:wght@400;500;600&family=JetBrains+Mono:wght@400;500;600&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$3 = () => import("./verify-Cwve2_Tf.js");
const Route$3 = createFileRoute("/verify")({
  validateSearch: (s) => ({
    id: typeof s.id === "string" ? s.id : ""
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard-BzRfqv0v.js");
const Route$2 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./auth-D4N8COkZ.js");
const Route$1 = createFileRoute("/auth")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-B91W8EdQ.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const VerifyRoute = Route$3.update({
  id: "/verify",
  path: "/verify",
